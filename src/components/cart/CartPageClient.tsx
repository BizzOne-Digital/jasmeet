...
export function CartPageClient({ shippingThreshold = 100 }: { shippingThreshold?: number }) {
      ...
      <aside className="h-fit border border-white/10 bg-surface p-6">
        ...
        <div className="mt-6 space-y-3 text-sm">
          ...
          <input
            ...
            className="mt-2 h-11 w-full border border-white/15 bg-transparent px-3 text-sm outline-none focus:border-gold"
