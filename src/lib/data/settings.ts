...
export async function getSiteSettings(): Promise<SiteSettingsData> {
  try {
    ...
    return {
      ...
      localDeliveryFee:
        settings.localDeliveryFee ?? defaultSettings.localDeliveryFee,
      localDeliveryPostalCodes: settings.localDeliveryPostalCodes?.length
        ? settings.localDeliveryPostalCodes
        : defaultSettings.localDeliveryPostalCodes,
