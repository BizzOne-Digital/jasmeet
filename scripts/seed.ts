...
async function main() {
  ...
  const productDefs: ProductSeed[] = [
    ...
    // AuraWave — prefer `npm run seed:aurawave` for full copy, colors, and size charts
    {
      name: "Scallop Dress",
      ...
      description:
        "Designed to move effortlessly with you, the Scallop Dress combines elegant style with everyday performance. Featuring signature scalloped edges, a flattering sculpted fit, and built-in shorts, it's made for confidence on and off the court.",
      materials: "75% Nylon, 25% Spandex",
      careInstructions: "Machine wash cold. Hang dry. Do not iron directly on the logo.",
    ...
    },
    {
      ...
      description:
        "The Scallop One-Shoulder Set blends modern elegance with high-performance comfort — signature one-shoulder design, scalloped edges, and sculpting high-waisted leggings.",
      materials: "75% Nylon, 25% Spandex",
      careInstructions: "Machine wash cold. Hang dry. Do not iron directly on the logo.",
      fitDetails: "True to size. High-rise. Model wears size Small.",
      highlights: ["Matching set", "One-shoulder", "Sculpting fit"],
      isFeatured: true,
      isNewArrival: true,
      isOnSale: true,
      order: 2,
    },
    {
      ...
      description:
        "Signature asymmetrical one-shoulder design with refined scalloped edges — flattering, sculpted fit with lightweight support.",
      materials: "75% Nylon, 25% Spandex",
      careInstructions: "Machine wash cold. Hang dry. Do not iron directly on the logo.",
      fitDetails: "True to size. Medium support. Removable padding. Model wears size Small.",
      highlights: ["One-shoulder", "Medium support", "Removable padding"],
      isFeatured: true,
      isOnSale: true,
      order: 3,
    },
    {
      ...
      description:
        "Flattering high-rise waistband and body-contouring silhouette — support without compromising flexibility.",
      materials: "75% Nylon, 25% Spandex",
      careInstructions: "Machine wash cold. Hang dry. Do not iron directly on the logo.",
      fitDetails: "True to size. High-rise. Full-length. Model wears size Small.",
      highlights: ["High-waisted", "Compression fit", "Squat-proof"],
      isFeatured: true,
      isOnSale: true,
      order: 4,
    },
    {
      ...
      description:
        "Signature scalloped halter neckline, sculpting high-waist flared leggings, and ultra-soft second-skin feel — studio to everyday.",
      materials: "82% Nylon, 18% Spandex",
      careInstructions: "Machine wash cold. Hang dry. Do not iron on logo.",
      fitDetails: "True to size. High-rise. Supportive halter. Model wears size Small.",
      highlights: ["Halter + flare", "Bundle & save", "Second-skin fabric"],
      isFeatured: true,
      isNewArrival: true,
      isOnSale: true,
      order: 5,
    },
    {
      ...
      description:
        "Elegant scalloped detailing with supportive comfort — transitions seamlessly from workouts to everyday wear.",
      materials: "82% Nylon, 18% Spandex",
      careInstructions: "Machine wash cold. Hang dry. Do not iron on logo.",
      fitDetails: "True to size. Medium support. Model wears size Small.",
      highlights: ["Scallop halter", "Medium support", "Buttery soft"],
      isFeatured: true,
      isOnSale: true,
      order: 6,
    },
    {
      ...
      description:
        "Flattering high-rise waistband and elegant flared leg silhouette — all-day comfort from studio to street.",
      materials: "82% Nylon, 18% Spandex",
      careInstructions: "Machine wash cold. Hang dry. Do not iron on logo.",
      fitDetails: "True to size. High-rise. Sculpting silhouette. Model wears size Small.",
      highlights: ["Signature flare", "High-rise", "Second-skin fabric"],
      isFeatured: true,
      isNewArrival: true,
      isOnSale: true,
      order: 7,
